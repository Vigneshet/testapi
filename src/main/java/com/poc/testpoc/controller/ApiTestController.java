...
public class ApiTestController {
	...
	public String showApiList(Model model) {
		...
		api.setId(1);
		api.setWebServiceName("Test");
		api.setWebServiceUrl("https://jsonplaceholder.typicode.com/users");
		api.setUsername("check");
		api.setPassword("check");
		ApiDetails api1 = new ApiDetails();
		api1.setId(2);
		api1.setWebServiceName("Test");
		api1.setWebServiceUrl("https://jsonplaceholder.typicode.com/users");
		api1.setUsername("check");
		api1.setPassword("check");
		ApiDetails api2 = new ApiDetails();
		api2.setId(3);
		api2.setWebServiceName("Test");
		api2.setWebServiceUrl("https://jsonplaceholder.typicode.com/users");
		api2.setUsername("check");
		api2.setPassword("check");
		apiList.add(api);
		apiList.add(api1);
		apiList.add(api2);
